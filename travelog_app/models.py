...
class diary(models.Model):
    ...
    prefectures = models.ForeignKey(prefectures, verbose_name='都道府県', null=True, on_delete=models.PROTECT)
    city = models.ForeignKey(cities, verbose_name='市町村区', null=True, on_delete=models.PROTECT)
